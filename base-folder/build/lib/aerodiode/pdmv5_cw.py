...
class Pdmv5_cw(Aerodiode):
    ...
    #INSTRUCT_PULSE_WIDTH                        = 0x2F to erase
    #INSTRUCT_PULSE_IN_THRESHOLD                 = 0x31 to erase
    ...
    INSTRUCT_MODULATION_FREQUENCY               = 0x4A #float not int pb
    INSTRUCT_GAIN_EXT_MODULATION                = 0x4B #ok
    INSTRUCT_BFM_GAIN                           = 0x50 #ok
    INSTRUCT_PD_EXT_GAIN                        = 0x51 #ok
    #INSTRUCT_INTER_TIME_MEASURE_LIV             = 0x5A to erase
    #INSTRUCT_LIVE_MEASURE_COUNT_AVERAGE         = 0x5B to erase
    #INSTRUCT_LIV_CURRENT_STEP                   = 0x5C to erase
    #INSTRUCT_LIV_CURRENT_MIN                    = 0x5D to erase
    #INSTRUCT_LIV_CURRENT_MAX                    = 0x5E to erase
    #INSTRUCT_LIV_PHOTODIODE                     = 0x5F to erase
    #INSTRUCT_PULSE_WIDTH_LIV                    = 0x60 to erase
