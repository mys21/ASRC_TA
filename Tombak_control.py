...
class Tombak_control:
    def __init__(self):
        ...
        self.frame_pulse_delay = 111100 #222200 - for divide by 3 method # units of 100 ps
        self.division = 1
    ...
    def line_parameters(self):
        ...
        tombak.set_status_instruction(tombak.INSTRUCT_SYNC_OUT_2_SOURCE, 0)	#
        tombak.apply_all()
    ...
    def frame_parameters(self,num_shots):
        ...
        self.division = ceil(1/4*num_shots) # ceil(1/3*num_shots) # should have the same division as the pump pulse for the laser
        ...
        tombak.set_status_instruction(tombak.INSTRUCT_SYNC_OUT_2_SOURCE, 1)	#IR camera
        tombak.apply_all()
