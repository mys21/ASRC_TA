...
class camera1(QObject):
	...
	def Initialize(self, number_of_scans=100, line_period=9):
	    ...
	    self.log.append('Number of Cameras: ',ulNbCameras.value)	#Works
